...
statement='''create table Users(UserId number(10) primary key,UserName varchar(30) not null,Password varchar(20) not null,UserType varchar(20) check (UserType in ('Employer','Jobseeker')))'''
...
userid = int(input("UserID: ")) #Enter 4
username =raw_input("UserName: ") #Enter careers@amazon.com
password = raw_input("Password: ") #Enter amazonindia
usertype = raw_input("UserType: ") #Enter Employer
